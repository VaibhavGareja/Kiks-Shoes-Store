  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 py-8  md:py-20">
      <div className="cat-head mb-12">
        <h1
          id="cat-header"
          className="text-center font-bold text-3xl md:text-4xl mb-4"
        >
          Choose Categories
        </h1>
        <p
          id="cat-pera"
          className="text-center max-w-3xl mx-auto text-sm md:text-base"
        >
      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 md:gap-8 lg:gap-8">
